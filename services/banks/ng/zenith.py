"""Zenith Bank statement extractor."""
...
class ZenithBankExtractor(BaseBankExtractor):
    """Extractor for Zenith Bank PLC statements."""

    bank_name: str = "Zenith Bank"
    bank_code: str = "zenith"
    aliases: tuple[str, ...] = ("zenith_bank", "zenith_bank_plc")

    def detect(self, text: str) -> bool:
        head = text[:3000].lower()
        return (
            "zenith bank" in head
            or "zenithbank.com" in head
        )
    ...
    def extract(
        ...
        *,
        ...
        source = source_name or "zenith_statement"
