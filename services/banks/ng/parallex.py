"""Parallex Bank statement extractor."""
...
class ParallexExtractor(BaseBankExtractor):
    """Extractor for Parallex Bank statement documents."""

    bank_name: str = "Parallex Bank"
    bank_code: str = "parallex"
    aliases: tuple[str, ...] = ("parallex_bank", "parallex_ng")

    def detect(self, text: str) -> bool:
        head = text[:3000].lower()
        return (
            "parallex bank" in head
            or "parallex" in head
            or "parallexbank.com" in head
        )
    ...
    def extract(
        ...
        *,
        ...
        source = source_name or "parallex_statement"
